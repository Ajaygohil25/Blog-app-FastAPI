...
async def send_mail(email: str, subject: str, content: str):
    ...
    <head>
        ...
        <title>Email from Blog Application</title>
        <style>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; margin: 0 auto;">
            <tr>
                <td style="padding: 20px 0; text-align: center;">
                    <h2 style="font-size: 24px; color: #fff; margin-bottom: 10px;">It's from Blog Application</h2>
                </td>
            </tr>
            <tr>
                <td style="padding: 10px 20px; background-color: #1a1a1a; border-radius: 8px;">
                    ...
                    <p style="font-size: 16px; color: #fff; margin-bottom: 0;">Thanks for using Blog app. We hope you enjoy it!</p>
                </td>
            </tr>
            <tr>
                <td style="padding: 20px 0; text-align: center;">
                    <p style="font-size: 14px; color: #ccc;">&copy; 2025 Blog Application. All rights reserved.</p>
                </td>
            </tr>
        </table>
    </body>
